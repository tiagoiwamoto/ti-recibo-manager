...
O acesso é protegido por Keycloak (`keycloak-js`). Veja [`../AUTH.md`](../AUTH.md) para a configuração do realm/client, certificado compartilhado e variáveis de ambiente.
